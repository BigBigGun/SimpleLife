...
//        UITapGestureRecognizer *Tap = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(calloutTap)];
...
- (void)initSubViews
{
    ...
    self.portraitView.frame = CGRectMake(kPortraitMargin, kPortraitMargin, kPortraitWidth, kPortraitHeight);
...
//- (void)calloutTap
//{
////    if (self.delegate && [self respondsToSelector:@selector(calloutTapAction)]) {
////        [self.delegate calloutTapAction];
////    }
//    self.calloutTapAction();
//}
...
{
    [self.portraitView setImage:image forState:UIControlStateNormal];
}
